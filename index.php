...
<div class="banner">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> TRAVEL IS AN INVESTMENT IN YOURSELF </h1>
	</div>
</div>
...
<div class="top-header">
	<div class="container">
		...
		<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			<li class="tol">Toll Number : 8125340720</li>				
